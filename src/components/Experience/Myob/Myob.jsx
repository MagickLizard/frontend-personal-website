			...
			<section className='section'>
				...
				<div className='container columns'>
					...
					<div className='column is-4'>
						<h3 className='title is-6'>Contributions</h3>
						<p className='content'>
							Some components I built include the core navigation, navigation
							for a internal sub-site and the price calculator.
							<br />
							<br />
